const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GRAVELER]              = {{EVO_HELD_ITEM, ITEM_HARD_STONE, SPECIES_GOLEM}},
    ...
    [SPECIES_BOLDORE]               = {{EVO_HELD_ITEM, ITEM_HARD_STONE, SPECIES_GIGALITH}},
    ...
    [SPECIES_GURDURR]               = {{EVO_LEVEL, 64, SPECIES_CONKELDURR}},
    ...
    [SPECIES_SPRITZEE]              = {{EVO_HELD_ITEM, ITEM_SACHET, SPECIES_AROMATISSE}},
    [SPECIES_SWIRLIX]               = {{EVO_HELD_ITEM, ITEM_WHIPPED_DREAM, SPECIES_SLURPUFF}},
    ...
    [SPECIES_PHANTUMP]              = {{EVO_HELD_ITEM, ITEM_MIRACLE_SEED, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]             = {{EVO_MAPSEC, MAPSEC_MT_PYRE, SPECIES_GOURGEIST}},
    ...
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_HELD_ITEM, ITEM_NONE, SPECIES_GOLEM_ALOLAN}}, // To do: swap ITEM_NONE with ITEM_STRANGE_SOUVENIR once that's added into the IE.
    ...
    [SPECIES_PUMPKABOO_SMALL]       = {{EVO_MAPSEC, MAPSEC_MT_PYRE, SPECIES_GOURGEIST_SMALL}},
    [SPECIES_PUMPKABOO_LARGE]       = {{EVO_MAPSEC, MAPSEC_MT_PYRE, SPECIES_GOURGEIST_LARGE}},
    [SPECIES_PUMPKABOO_SUPER]       = {{EVO_MAPSEC, MAPSEC_MT_PYRE, SPECIES_GOURGEIST_SUPER}},
