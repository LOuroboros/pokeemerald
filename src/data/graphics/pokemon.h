...
const u32 gMonPalette_Egg_Fairy1[] = INCBIN_U32("graphics/pokemon/egg/types/fairy1.gbapal.lz");
const u32 gMonPalette_Egg_Fairy2[] = INCBIN_U32("graphics/pokemon/egg/types/fairy2.gbapal.lz");
