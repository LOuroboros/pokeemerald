static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_TWINLEAF_TOWN - 1] = {MAP_GROUP(TWINLEAF_TOWN), MAP_NUM(TWINLEAF_TOWN), 16, 19},
    [HEAL_LOCATION_SANDGEM_TOWN - 1] = {MAP_GROUP(SANDGEM_TOWN), MAP_NUM(SANDGEM_TOWN), 15, 9},
};
