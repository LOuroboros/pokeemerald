...
static const struct TrainerMonNoItemDefaultMoves sParty_Rival1_Charmander[] = {
    {
    .iv = 0,
    .lvl = 5,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Rival1_Squirtle[] = {
    {
    .iv = 0,
    .lvl = 5,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Rival1_Bulbasaur[] = {
    {
    .iv = 0,
    .lvl = 5,
