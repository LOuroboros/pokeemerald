...
static void FormatAndPrintText(const u8 *src)
{
    ...
    MoveRelearnerPrintText(gStringBuffer);
}
...
static void HideHeartSpritesAndShowTeachMoveText(bool8 onlyHideSprites)
{
    ...
    if (!onlyHideSprites)
    {
        StringExpandPlaceholders(gStringBuffer, gText_TeachWhichMoveToPkmn);
        FillWindowPixelBuffer(3, 0x11);
        AddTextPrinterParameterized(3, FONT_NORMAL, gStringBuffer, 0, 1, 0, NULL);
    }
}
...
static void HandleInput(bool8 showContest)
{
    ...
    case LIST_CANCEL:
        ...
        StringExpandPlaceholders(gStringBuffer, gText_MoveRelearnerGiveUp);
        MoveRelearnerPrintText(gStringBuffer);
        break;
    default:
        PlaySE(SE_SELECT);
        ...
        StringExpandPlaceholders(gStringBuffer, gText_MoveRelearnerTeachMoveConfirm);
        MoveRelearnerPrintText(gStringBuffer);
        break;
    }
}
