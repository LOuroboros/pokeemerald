...
static bool8 AnimateTradeSequenceCable(void)
{
    ...
    case TS_STATE_SEND_MSG:
        StringExpandPlaceholders(gStringVar11, gText_XWillBeSentToY);
        DrawTextOnTradeWindow(0, gStringVar11, 0);
    ...
    case TS_STATE_BYE_BYE:
        if (++sTradeData->timer == 80)
        {
            ...
            sTradeData->state++;
            StringExpandPlaceholders(gStringVar11, gText_ByeByeVar1);
            DrawTextOnTradeWindow(0, gStringVar11, 0);
        }
        break;
    ...
    case TS_STATE_NEW_MON_MSG:
        SetGpuReg(REG_OFFSET_DISPCNT, DISPCNT_MODE_0 |
                                      ...
                                      DISPCNT_BG2_ON |
                                      DISPCNT_OBJ_ON);
        StringExpandPlaceholders(gStringVar11, gText_XSentOverY);
        DrawTextOnTradeWindow(0, gStringVar11, 0);
    ...
    case TS_STATE_TAKE_CARE_OF_MON:
        ...
        {
            sTradeData->state++;
            StringExpandPlaceholders(gStringVar11, gText_TakeGoodCareOfX);
            DrawTextOnTradeWindow(0, gStringVar11, 0);
            sTradeData->timer = 0;
        }
        break;
...
static void CB2_SaveAndEndTrade(void)
{
    ...
    case 0:
        gMain.state++;
        StringExpandPlaceholders(gStringVar11, gText_CommunicationStandby5);
        DrawTextOnTradeWindow(0, gStringVar11, 0);
        break;
    case 1:
    ...
    case 2:
        gMain.state = 50;
        StringExpandPlaceholders(gStringVar11, gText_SavingDontTurnOffPower);
        DrawTextOnTradeWindow(0, gStringVar11, 0);
        break;
    case 50:
        if (!InUnionRoom())
