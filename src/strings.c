...
const u8 gText_XNatureHatchedAtYZ[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1} nature, hatched at\n{LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1} on {DYNAMIC 0}{DYNAMIC 5} {DYNAMIC 6}, 20{DYNAMIC 7}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNatureObtainedInTrade[] = _("{DYNAMIC 0}{DYNAMIC 2}{DYNAMIC 1} nature, obtained in\na trade on {DYNAMIC 0}{DYNAMIC 5} {DYNAMIC 6}, 20{DYNAMIC 7}{DYNAMIC 1}.");
...
const u8 gText_EggFoundIn[] = _("A POKéMON EGG obtained\non {DYNAMIC 0}{DYNAMIC 5} {DYNAMIC 6}, 20{DYNAMIC 7}{DYNAMIC 1},\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
...
const u8 gText_EVO_FRIENDSHIP[]                   = _("Lv. up with high friendship");
const u8 gText_EVO_FRIENDSHIP_DAY[]               = _("Lv. up with high friendship (day)");
const u8 gText_EVO_FRIENDSHIP_NIGHT[]             = _("Lv. up with high friendship (night)");
const u8 gText_EVO_LEVEL[]                        = _("Reach Lv. {STR_VAR_2}");
const u8 gText_EVO_TRADE[]                        = _("When traded");
const u8 gText_EVO_TRADE_ITEM[]                   = _("When traded while holding {STR_VAR_2}");
const u8 gText_EVO_ITEM[]                         = _("Use {STR_VAR_2}");
const u8 gText_EVO_LEVEL_ATK_GT_DEF[]             = _("Reach Lv. {STR_VAR_2} with high DEF.");
const u8 gText_EVO_LEVEL_ATK_EQ_DEF[]             = _("Reach Lv. {STR_VAR_2} with equal ATK. & DEF.");
const u8 gText_EVO_LEVEL_ATK_LT_DEF[]             = _("Reach Lv. {STR_VAR_2} with high ATK.");
const u8 gText_EVO_LEVEL_SILCOON[]                = _("Reach Lv. {STR_VAR_2} with specific PID");
const u8 gText_EVO_LEVEL_CASCOON[]                = _("Reach Lv. {STR_VAR_2} with specific PID");
const u8 gText_EVO_LEVEL_NINJASK[]                = _("Reach Lv. {STR_VAR_2}");
const u8 gText_EVO_LEVEL_SHEDINJA[]               = _("Reach Lv. {STR_VAR_2}, 1 free party slot");
const u8 gText_EVO_BEAUTY[]                       = _("Lv. up with high beauty.");
const u8 gText_EVO_LEVEL_FEMALE[]                 = _("Reach Lv. {STR_VAR_2}, is female");
const u8 gText_EVO_LEVEL_MALE[]                   = _("Reach Lv. {STR_VAR_2}, is male");
const u8 gText_EVO_LEVEL_NIGHT[]                  = _("Reach Lv. {STR_VAR_2} at night");
const u8 gText_EVO_LEVEL_DAY[]                    = _("Reach Lv. {STR_VAR_2} at day");
const u8 gText_EVO_LEVEL_DUSK[]                   = _("Reach Lv. {STR_VAR_2} at dusk (17:00-18:00)");
const u8 gText_EVO_ITEM_HOLD_DAY[]                = _("Lv. up holding {STR_VAR_2} at day");
const u8 gText_EVO_ITEM_HOLD_NIGHT[]              = _("Lv. up holding {STR_VAR_2} at night");
const u8 gText_EVO_MOVE[]                         = _("Lv. up knowing {STR_VAR_2}");
const u8 gText_EVO_MOVE_TYPE[]                    = _("Lv. up knowing a {STR_VAR_2} type move");
const u8 gText_EVO_MAPSEC[]                       = _("Lv. up in {STR_VAR_2}");
const u8 gText_EVO_ITEM_MALE[]                    = _("Use {STR_VAR_2} if Male");
const u8 gText_EVO_ITEM_FEMALE[]                  = _("Use {STR_VAR_2} if Female");
const u8 gText_EVO_LEVEL_RAIN[]                   = _("Reach Lv. {STR_VAR_2} while raining");
const u8 gText_EVO_SPECIFIC_MON_IN_PARTY[]        = _("Lv. up with a {STR_VAR_2} in party");
const u8 gText_EVO_LEVEL_DARK_TYPE_MON_IN_PARTY[] = _("Lv. up with with Dark type in party");
const u8 gText_EVO_TRADE_SPECIFIC_MON[]           = _("When traded for a {STR_VAR_2}");
const u8 gText_EVO_SPECIFIC_MAP[]                 = _("Lv. up in {STR_VAR_2}");
const u8 gText_EVO_HELD_ITEM[]                    = _("Lv. up holding {STR_VAR_2}");
...
const u8 gText_BattleType[] = _("BATTLE TYPE");
...
// Completed Side Quests Description
