...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("GREEN");
const u8 gText_ExpandedPlaceholder_May[] = _("GREEN");
...
const u8 gText_DefaultNameRed[] = _("RED");
const u8 gText_DefaultNameAsh[] = _("ASH");
const u8 gText_DefaultNameBlue[] = _("BLUE");
const u8 gText_DefaultNameLeaf[] = _("LEAF");
