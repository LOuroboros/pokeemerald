...
static void PrintBerryNumberAndName(void)
{
    ...
    StringExpandPlaceholders(gStringBuffer, gText_NumberVar1Var2);
    PrintTextInBerryTagScreen(WIN_BERRY_NAME, gStringBuffer, 0, 1, 0, 0);
}
...
static void PrintBerrySize(void)
{
    ...
    if (berry->size != 0)
    {
        ...
        StringExpandPlaceholders(gStringBuffer, gText_Var1DotVar2);
        AddTextPrinterParameterized(WIN_SIZE_FIRM, FONT_NORMAL, gStringBuffer, 0x28, 1, 0, NULL);
    }
    else
    {
