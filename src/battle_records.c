...
static void PrintLinkBattleWinsLossesDraws(struct LinkBattleRecord *records)
{
    ...
    x = GetStringCenterAlignXOffset(1, gStringVar7, 0xD0);
    AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar7, x, 0x11, 0, NULL);
}
...
void ShowLinkBattleRecords(void)
{
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar7, x, 1, 0, NULL);
    ...
    AddTextPrinterParameterized(gRecordsWindowId, 1, gStringVar7, 0, 41, 0, NULL);
