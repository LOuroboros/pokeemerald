...
{
    [COSTUME_1] = {TRAINER_BACK_PIC_BRENDAN, TRAINER_BACK_PIC_MAY},
    [COSTUME_2] = {TRAINER_BACK_PIC_RUBY_SAPPHIRE_BRENDAN, TRAINER_BACK_PIC_RUBY_SAPPHIRE_MAY},
    [COSTUME_3] = {TRAINER_BACK_PIC_ADVENTURES_BRENDAN, TRAINER_BACK_PIC_ADVENTURES_MAY},
};
...
static void PlayerHandleIntroTrainerBallThrow(void)
{
    ...
    LoadPalette(gTrainerBackPicPaletteTable[sCostumeBackPics[gSaveBlock2Ptr->costumeId][gSaveBlock2Ptr->playerGender]].data, 0x100 + paletteNum * 16, 32);
