...
static void BagMenu_ItemPrintCallback(u8 windowId, u32 itemIndex, u8 y)
{
    ...
    if (itemIndex != LIST_CANCEL)
    {
        ...
        if (gBagPosition.pocket == BERRIES_POCKET)
        {
            ...
            StringExpandPlaceholders(gStringBuffer, gText_xVar1);
            offset = GetStringRightAlignXOffset(FONT_NARROW, gStringBuffer, 119);
            BagMenu_Print(windowId, FONT_NARROW, gStringBuffer, offset, y, 0, 0, TEXT_SKIP_DRAW, COLORID_NORMAL);
        }
...
static void PrintItemDescription(int itemIndex)
{
    ...
    else
    {
        ...
        StringExpandPlaceholders(gStringBuffer, gText_ReturnToVar1);
        str = gStringBuffer;
    }
...
static void PrintItemQuantity(u8 windowId, s16 quantity)
{
    ...
    StringExpandPlaceholders(gStringBuffer, gText_xVar1);
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gStringBuffer, GetStringCenterAlignXOffset(FONT_NORMAL, gStringBuffer, 0x28), 2, 0, 0);
}
...
static void PrintItemSoldAmount(int windowId, int numSold, int moneyEarned)
{
    ...
    StringExpandPlaceholders(gStringBuffer, gText_xVar1);
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gStringBuffer, 0, 1, TEXT_SKIP_DRAW, 0);
...
static void StartItemSwap(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringBuffer, gText_MoveVar1Where);
    FillWindowPixelBuffer(WIN_DESCRIPTION, PIXEL_FILL(0));
    BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gStringBuffer, 3, 1, 0, 0, 0, COLORID_NORMAL);
...
static void OpenContextMenu(u8 taskId)
{
    ...
    else
    {
        ...
        StringExpandPlaceholders(gStringBuffer, gText_Var1IsSelected);
        FillWindowPixelBuffer(WIN_DESCRIPTION, PIXEL_FILL(0));
        BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gStringBuffer, 3, 1, 0, 0, 0, COLORID_NORMAL);
    }
...
static void ItemMenu_Toss(u8 taskId)
{
    ...
    {
        CopyItemName(gSpecialVar_ItemId, gStringVar1);
        StringExpandPlaceholders(gStringBuffer, gText_TossHowManyVar1s);
        FillWindowPixelBuffer(WIN_DESCRIPTION, PIXEL_FILL(0));
        BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gStringBuffer, 3, 1, 0, 0, 0, COLORID_NORMAL);
...
static void AskTossItems(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringBuffer, gText_ConfirmTossItems);
    FillWindowPixelBuffer(WIN_DESCRIPTION, PIXEL_FILL(0));
    BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gStringBuffer, 3, 1, 0, 0, 0, COLORID_NORMAL);
...
static void ConfirmToss(u8 taskId)
{
    ...
    CopyItemName(gSpecialVar_ItemId, gStringVar1);
    ConvertIntToDecimalStringN(gStringVar2, tItemCount, STR_CONV_MODE_LEFT_ALIGN, MAX_ITEM_DIGITS);
    StringExpandPlaceholders(gStringBuffer, gText_ThrewAwayVar2Var1s);
    FillWindowPixelBuffer(WIN_DESCRIPTION, PIXEL_FILL(0));
    BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gStringBuffer, 3, 1, 0, 0, 0, COLORID_NORMAL);
...
{
    CopyItemName(gSpecialVar_ItemId, gStringVar1);
    StringExpandPlaceholders(gStringBuffer, gText_Var1CantBeHeld);
    DisplayItemMessage(taskId, FONT_NORMAL, gStringBuffer, HandleErrorMessage);
}
...
static void Task_ItemContext_GiveToParty(u8 taskId)
{
    ...
    {
        CopyItemName(gSpecialVar_ItemId, gStringVar1);
        StringExpandPlaceholders(gStringBuffer, gText_Var1CantBeHeldHere);
        DisplayItemMessage(taskId, FONT_NORMAL, gStringBuffer, HandleErrorMessage);
    }
...
static void Task_ItemContext_Sell(u8 taskId)
{
    ...
    if (ItemId_GetPrice(gSpecialVar_ItemId) == 0)
    {
        ...
        StringExpandPlaceholders(gStringBuffer, gText_CantBuyKeyItem);
        DisplayItemMessage(taskId, FONT_NORMAL, gStringBuffer, CloseItemMessage);
    }
    else
    {
        tItemCount = 1;
        ...
        {
            CopyItemName(gSpecialVar_ItemId, gStringVar2);
            StringExpandPlaceholders(gStringBuffer, gText_HowManyToSell);
            DisplayItemMessage(taskId, FONT_NORMAL, gStringBuffer, InitSellHowManyInput);
        }
    }
}
...
static void DisplaySellItemPriceAndConfirm(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringBuffer, gText_ICanPayVar1);
    DisplayItemMessage(taskId, FONT_NORMAL, gStringBuffer, AskSellItems);
}
...
static void ConfirmSell(u8 taskId)
{
    ...
    CopyItemName(gSpecialVar_ItemId, gStringVar2);
    ConvertIntToDecimalStringN(gStringVar1, (ItemId_GetPrice(gSpecialVar_ItemId) / 2) * tItemCount, STR_CONV_MODE_LEFT_ALIGN, 6);
    StringExpandPlaceholders(gStringBuffer, gText_TurnedOverVar1ForVar2);
    DisplayItemMessage(taskId, FONT_NORMAL, gStringBuffer, SellItem);
}
...
static void Task_ItemContext_Deposit(u8 taskId)
{
    ...
    {
        CopyItemName(gSpecialVar_ItemId, gStringVar1);
        StringExpandPlaceholders(gStringBuffer, gText_DepositHowManyVar1);
        FillWindowPixelBuffer(WIN_DESCRIPTION, PIXEL_FILL(0));
        BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gStringBuffer, 3, 1, 0, 0, 0, COLORID_NORMAL);
        AddItemQuantityWindow(ITEMWIN_QUANTITY);
...
static void TryDepositItem(u8 taskId)
{
    ...
    else if (AddPCItem(gSpecialVar_ItemId, tItemCount) == TRUE)
    {
        ...
        CopyItemName(gSpecialVar_ItemId, gStringVar1);
        ConvertIntToDecimalStringN(gStringVar2, tItemCount, STR_CONV_MODE_LEFT_ALIGN, MAX_ITEM_DIGITS);
        StringExpandPlaceholders(gStringBuffer, gText_DepositedVar2Var1s);
        BagMenu_Print(WIN_DESCRIPTION, FONT_NORMAL, gStringBuffer, 3, 1, 0, 0, 0, COLORID_NORMAL);
        gTasks[taskId].func = Task_RemoveItemFromBag;
    }
    else
