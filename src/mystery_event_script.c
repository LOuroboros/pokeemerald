...
{
    StringExpandPlaceholders(gStringBuffer, gText_MysteryEventCantBeUsed);
...
bool8 MEScrCmd_giveribbon(struct ScriptContext *ctx)
{
    ...
    StringExpandPlaceholders(gStringBuffer, gText_MysteryEventSpecialRibbon);
    ctx->mStatus = MEVENT_STATUS_SUCCESS;
    return FALSE;
}
...
bool8 MEScrCmd_givenationaldex(struct ScriptContext *ctx)
{
    ...
    StringExpandPlaceholders(gStringBuffer, gText_MysteryEventNationalDex);
    ctx->mStatus = MEVENT_STATUS_SUCCESS;
    return FALSE;
}
...
bool8 MEScrCmd_addrareword(struct ScriptContext *ctx)
{
    ...
    StringExpandPlaceholders(gStringBuffer, gText_MysteryEventRareWord);
    ctx->mStatus = MEVENT_STATUS_SUCCESS;
    return FALSE;
}
...
bool8 MEScrCmd_givepokemon(struct ScriptContext *ctx)
{
    ...
    {
        StringExpandPlaceholders(gStringBuffer, gText_MysteryEventFullParty);
    ...
    else
    {
        ...
        StringExpandPlaceholders(gStringBuffer, gText_MysteryEventSentOver);
        ctx->mStatus = MEVENT_STATUS_SUCCESS;
    }
...
bool8 MEScrCmd_addtrainer(struct ScriptContext *ctx)
{
    ...
    StringExpandPlaceholders(gStringBuffer, gText_MysteryEventNewTrainer);
    ctx->mStatus = MEVENT_STATUS_SUCCESS;
    return FALSE;
}
...
{
    EnableResetRTC();
    StringExpandPlaceholders(gStringBuffer, gText_InGameClockUsable);
    ctx->mStatus = MEVENT_STATUS_SUCCESS;
    return FALSE;
}
