...
static void Select_PrintMonSpecies(void)
{
    ...
    StringCopy(gStringBuffer, gSpeciesNames[species]);
    x = GetStringRightAlignXOffset(FONT_NORMAL, gStringBuffer, 86);
    AddTextPrinterParameterized3(SELECT_WIN_SPECIES, FONT_NORMAL, x, 1, sSpeciesNameTextColors, 0, gStringBuffer);
...
static void Swap_PrintMonSpecies(void)
{
    ...
    else
    {
        ...
        StringCopy(gStringBuffer, gSpeciesNames[species]);
        x = GetStringRightAlignXOffset(FONT_NORMAL, gStringBuffer, 86);
        AddTextPrinterParameterized3(SWAP_WIN_SPECIES, FONT_NORMAL, x, 1, sSwapSpeciesNameTextColors, 0, gStringBuffer);
...
static void Swap_PrintMonSpeciesAtFade(void)
{
    ...
    else
    {
        ...
        StringCopy(gStringBuffer, gSpeciesNames[species]);
        x = GetStringRightAlignXOffset(FONT_NORMAL, gStringBuffer, 86);
        AddTextPrinterParameterized3(SWAP_WIN_SPECIES_AT_FADE, FONT_NORMAL, x, 1, sSwapSpeciesNameTextColors, 0, gStringBuffer);
        CopyWindowToVram(SWAP_WIN_SPECIES_AT_FADE, COPYWIN_FULL);
    }
}
