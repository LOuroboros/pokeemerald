...
static void Select_PrintMonSpecies(void)
{
    ...
    StringCopy(gStringVar11, gSpeciesNames[species]);
    x = GetStringRightAlignXOffset(FONT_NORMAL, gStringVar11, 86);
    AddTextPrinterParameterized3(SELECT_WIN_SPECIES, FONT_NORMAL, x, 1, sSpeciesNameTextColors, 0, gStringVar11);
...
static void Swap_PrintMonSpecies(void)
{
    ...
    else
    {
        ...
        StringCopy(gStringVar11, gSpeciesNames[species]);
        x = GetStringRightAlignXOffset(FONT_NORMAL, gStringVar11, 86);
        AddTextPrinterParameterized3(SWAP_WIN_SPECIES, FONT_NORMAL, x, 1, sSwapSpeciesNameTextColors, 0, gStringVar11);
...
static void Swap_PrintMonSpeciesAtFade(void)
{
    ...
    else
    {
        ...
        StringCopy(gStringVar11, gSpeciesNames[species]);
        x = GetStringRightAlignXOffset(FONT_NORMAL, gStringVar11, 86);
        AddTextPrinterParameterized3(SWAP_WIN_SPECIES_AT_FADE, FONT_NORMAL, x, 1, sSwapSpeciesNameTextColors, 0, gStringVar11);
        CopyWindowToVram(SWAP_WIN_SPECIES_AT_FADE, COPYWIN_FULL);
    }
}
