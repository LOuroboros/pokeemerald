...
static void Task_DisplayMainMenu(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        DISPLAY_HAS_SAVED_GAME_NOPKMN:
            ...
            AddTextPrinterParameterized3(3, 1, 0, 0, sTextColor_Headers, -1, gText_MainMenuNewGame);
...
static void Task_NewGameBirchSpeech_ThisIsAPokemon(u8 taskId)
{
    if (!gPaletteFade.active && !RunTextPrintersAndIsPrinter0Active())
    {
        ...
        StringExpandPlaceholders(gStringVar7, gText_ThisIsAPokemon);
...
static void Task_NewGameBirchSpeech_MainSpeech(u8 taskId)
{
    ...
    {
        StringExpandPlaceholders(gStringVar7, gText_Birch_MainSpeech);
        AddTextPrinterForMessage(1);
...
static void Task_NewGameBirchSpeech_AndYouAre(u8 taskId)
{
    ...
    {
        gUnknown_02022D04 = 0;
        StringExpandPlaceholders(gStringVar7, gText_Birch_AndYouAre);
        AddTextPrinterForMessage(1);
...
{
    NewGameBirchSpeech_ClearWindow(0);
    StringExpandPlaceholders(gStringVar7, gText_Birch_BoyOrGirl);
    AddTextPrinterForMessage(1);
...
{
    NewGameBirchSpeech_ClearWindow(0);
    StringExpandPlaceholders(gStringVar7, gText_Birch_WhatsYourName);
    AddTextPrinterForMessage(1);
...
{
    NewGameBirchSpeech_ClearWindow(0);
    StringExpandPlaceholders(gStringVar7, gText_Birch_SoItsPlayer);
    AddTextPrinterForMessage(1);
...
static void Task_NewGameBirchSpeech_ReshowBirchLotad(u8 taskId)
{
    ...
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        NewGameBirchSpeech_StartFadePlatformOut(taskId, 1);
        NewGameBirchSpeech_ClearWindow(0);
        StringExpandPlaceholders(gStringVar7, gText_Birch_YourePlayer);
        AddTextPrinterForMessage(1);
...
static void Task_NewGameBirchSpeech_AreYouReady(u8 taskId)
{
    ...
    if (gTasks[taskId].tIsDoneFadingSprites)
    {
        ...
        NewGameBirchSpeech_StartFadeInTarget1OutTarget2(taskId, 2);
        NewGameBirchSpeech_StartFadePlatformOut(taskId, 1);
        StringExpandPlaceholders(gStringVar7, gText_Birch_AreYouReady);
        AddTextPrinterForMessage(1);
...
{
    StringExpandPlaceholders(gStringVar7, gText_ContinueMenuPlayer);
    AddTextPrinterParameterized3(2 + 3 * hasParty, 1, 0, 17, sTextColor_MenuInfo, -1, gStringVar7);
    AddTextPrinterParameterized3(2 + 3 * hasParty, 1, GetStringRightAlignXOffset(1, gSaveBlock2Ptr->playerName, 100), 17, sTextColor_MenuInfo, -1, gSaveBlock2Ptr->playerName);
}
...
static void MainMenu_FormatSavegameTime(u8 hasParty)
{
    ...
    StringExpandPlaceholders(gStringVar7, gText_ContinueMenuTime);
    AddTextPrinterParameterized3(2 + 3 * hasParty, 1, 0x6C, 17, sTextColor_MenuInfo, -1, gStringVar7);
    ptr = ConvertIntToDecimalStringN(str, gSaveBlock2Ptr->playTimeHours, STR_CONV_MODE_LEFT_ALIGN, 3);
    *ptr = 0xF0;
    ConvertIntToDecimalStringN(ptr + 1, gSaveBlock2Ptr->playTimeMinutes, STR_CONV_MODE_LEADING_ZEROS, 2);
    AddTextPrinterParameterized3(2 + 3 * hasParty, 1, GetStringRightAlignXOffset(1, str, 0xD0), 17, sTextColor_MenuInfo, -1, str);
}
...
static void MainMenu_FormatSavegamePokedex(void)
{
    ...
    if (FlagGet(FLAG_SYS_POKEDEX_GET) == TRUE)
    {
        ...
        StringExpandPlaceholders(gStringVar7, gText_ContinueMenuPokedex);
        AddTextPrinterParameterized3(5, 1, 0, 33, sTextColor_MenuInfo, -1, gStringVar7);
        ConvertIntToDecimalStringN(str, dexCount, STR_CONV_MODE_LEFT_ALIGN, 3);
        AddTextPrinterParameterized3(5, 1, GetStringRightAlignXOffset(1, str, 100), 33, sTextColor_MenuInfo, -1, str);
    }
}
...
static void MainMenu_FormatSavegameBadges(void)
{
    ...
    StringExpandPlaceholders(gStringVar7, gText_ContinueMenuBadges);
    AddTextPrinterParameterized3(5, 1, 0x6C, 33, sTextColor_MenuInfo, -1, gStringVar7);
    ConvertIntToDecimalStringN(str, badgeCount, STR_CONV_MODE_LEADING_ZEROS, 1);
    AddTextPrinterParameterized3(5, 1, GetStringRightAlignXOffset(1, str, 0xD0), 33, sTextColor_MenuInfo, -1, str);
}
