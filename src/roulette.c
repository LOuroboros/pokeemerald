...
static void Task_PrintPayout(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringBuffer, Roulette_Text_YouveWonXCoins);
    DrawStdWindowFrame(sTextWindowId, FALSE);
    AddTextPrinterParameterized(sTextWindowId, FONT_NORMAL, gStringBuffer, 0, 1, TEXT_SKIP_DRAW, NULL);
    CopyWindowToVram(sTextWindowId, COPYWIN_FULL);
...
static void Task_PrintMinBet(u8 taskId)
{
    if (JOY_NEW(A_BUTTON | B_BUTTON))
    {
        ...
        StringExpandPlaceholders(gStringBuffer, Roulette_Text_PlayMinimumWagerIsX);
        DrawStdWindowFrame(0, FALSE);
        AddTextPrinterParameterized(0, FONT_NORMAL, gStringBuffer, 0, 1, TEXT_SKIP_DRAW, NULL);
...
static void Task_PrintRouletteEntryMsg(u8 taskId)
{
    ...
    else
    {
        ...
        StringExpandPlaceholders(gStringBuffer, Roulette_Text_NotEnoughCoins);
        DrawStdWindowFrame(0, FALSE);
        AddTextPrinterParameterized(0, FONT_NORMAL, gStringBuffer, 0, 1, TEXT_SKIP_DRAW, NULL);
        CopyWindowToVram(0, COPYWIN_FULL);
