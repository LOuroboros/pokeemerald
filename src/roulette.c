...
static void Task_PrintPayout(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringVar11, Roulette_Text_YouveWonXCoins);
    DrawStdWindowFrame(sTextWindowId, FALSE);
    AddTextPrinterParameterized(sTextWindowId, FONT_NORMAL, gStringVar11, 0, 1, TEXT_SKIP_DRAW, NULL);
    CopyWindowToVram(sTextWindowId, COPYWIN_FULL);
...
static void Task_PrintMinBet(u8 taskId)
{
    if (JOY_NEW(A_BUTTON | B_BUTTON))
    {
        ...
        StringExpandPlaceholders(gStringVar11, Roulette_Text_PlayMinimumWagerIsX);
        DrawStdWindowFrame(0, FALSE);
        AddTextPrinterParameterized(0, FONT_NORMAL, gStringVar11, 0, 1, TEXT_SKIP_DRAW, NULL);
...
static void Task_PrintRouletteEntryMsg(u8 taskId)
{
    ...
    else
    {
        ...
        StringExpandPlaceholders(gStringVar11, Roulette_Text_NotEnoughCoins);
        DrawStdWindowFrame(0, FALSE);
        AddTextPrinterParameterized(0, FONT_NORMAL, gStringVar11, 0, 1, TEXT_SKIP_DRAW, NULL);
        CopyWindowToVram(0, COPYWIN_FULL);
