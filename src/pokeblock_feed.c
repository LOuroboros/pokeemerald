...
static void Task_PrintAtePokeblockMessage(u8 taskId)
{
    ...
    if (gPokeblockGain == 0)
        StringExpandPlaceholders(gStringVar11, gText_Var1AteTheVar2);
    else if (gPokeblockGain > 0)
        StringExpandPlaceholders(gStringVar11, gText_Var1HappilyAteVar2);
    else
        StringExpandPlaceholders(gStringVar11, gText_Var1DisdainfullyAteVar2);
