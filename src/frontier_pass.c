...
static void ShowAndPrintWindows(void)
{
    ...
    ConvertIntToDecimalStringN(gStringBuffer, sPassData->battlePoints, STR_CONV_MODE_LEFT_ALIGN, 5);
    x = GetStringRightAlignXOffset(FONT_SMALL_NARROW, gStringBuffer, 91);
    AddTextPrinterParameterized3(WINDOW_BATTLE_POINTS, FONT_SMALL_NARROW, x, 16, sTextColors[0], 0, gStringBuffer);
