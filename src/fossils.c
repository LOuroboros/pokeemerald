...
u32 CountNumberUniqueFossils(void)
{
    u32 i;
    u32 count = 0;
...
static void Task_CreateFossilsMultichoice(u8 taskId)
{
...
void Script_CreateFossilsMultichoice(void)
{
    CreateTask(Task_CreateFossilsMultichoice, 10);
}
