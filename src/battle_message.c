...
static const u8 sText_TargetStockpiledEffectWoreOff[] = _("{B_DEF_NAME_WITH_PREFIX}'s stockpiled\neffect wore off!");

const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    [STRINGID_TARGETSTOCKPILEDEFFECTWOREOFF - 12] = sText_TargetStockpiledEffectWoreOff,
