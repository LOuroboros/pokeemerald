...
static const u8 sText_PkmnEnduredHit[] = _("{B_ATK_NAME_WITH_PREFIX} dealt {STR_VAR_3} damage!\nHowever, {B_DEF_NAME_WITH_PREFIX} endured the hit!");
...
static const u8 sText_CriticalHit[] = _("{B_ATK_NAME_WITH_PREFIX} dealt {STR_VAR_3} points\nof damage!\lIt was a critical hit!");
static const u8 sText_OneHitKO[] = _("{B_ATK_NAME_WITH_PREFIX} executed {B_DEF_NAME_WITH_PREFIX}\nfor {STR_VAR_3} damage!");
...
static const u8 sText_NotVeryEffective[] = _("{B_ATK_NAME_WITH_PREFIX}'s move wasn't very effective,\nbut it still dealt {STR_VAR_3} damage!");
static const u8 sText_SuperEffective[] = _("{B_ATK_NAME_WITH_PREFIX} dealt {STR_VAR_3} points\nof damage!\lIt was a super effective hit!");
...
{
    [STRINGID_DEALTDAMAGE - 12] = sText_DealtDamage,
