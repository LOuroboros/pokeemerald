...
static void Task_DisplayAppealNumberText(u8 taskId)
{
    if (gTasks[taskId].data[0] == 0)
    {
        ...
        StringExpandPlaceholders(gStringBuffer, gDisplayedStringBattle);
        Contest_StartTextPrinter(gStringBuffer, TRUE);
        gTasks[taskId].data[0]++;
    }
    else
    {
...
static void Task_HandleMoveSelectInput(u8 taskId)
{
    ...
    else
    {
        ...
        case B_BUTTON:
            ...
            ContestClearGeneralTextWindow();
            StringExpandPlaceholders(gStringBuffer, gDisplayedStringBattle);
            Contest_StartTextPrinter(gStringBuffer, FALSE);
            gBattle_BG0_Y = 0;
            gBattle_BG2_Y = 0;
            gTasks[taskId].func = Task_TryShowMoveSelectScreen;
            break;
...
static void Task_DoAppeals(u8 taskId)
{
    ...
    case APPEALSTATE_PRINT_USED_MOVE_MSG:
        ...
        else
        {
            ...
            StringExpandPlaceholders(gStringBuffer, gText_MonAppealedWithMove);
            Contest_StartTextPrinter(gStringBuffer, TRUE);
    ...
    case APPEALSTATE_TRY_PRINT_SKIP_NEXT_TURN_MSG:
        if (gTasks[taskId].tCounter++ > 9)
        {
                ...
                || eContestantStatus[contestant].turnSkipped)
            {
                ContestClearGeneralTextWindow();
                StringCopy(gStringVar1, gContestMons[contestant].nickname);
                StringExpandPlaceholders(gStringBuffer, gText_MonCantAppealNextTurn);
                Contest_StartTextPrinter(gStringBuffer, TRUE);
            }
    ...
    case APPEALSTATE_PRINT_COMBO_MSG:
    {
        ...
        else
        {
            ...
            ContestClearGeneralTextWindow();
            StringCopy(gStringVar1, gContestMons[contestant].nickname);
            StringExpandPlaceholders(gStringBuffer, gText_JudgeLookedAtMonExpectantly);
            Contest_StartTextPrinter(gStringBuffer, TRUE);
    ...
    case APPEALSTATE_CHECK_REPEATED_MOVE:
        if (eContestantStatus[contestant].repeatedMove)
        {
            ContestClearGeneralTextWindow();
            StringCopy(gStringVar1, gContestMons[contestant].nickname);
            StringExpandPlaceholders(gStringBuffer, gText_RepeatedAppeal);
            Contest_StartTextPrinter(gStringBuffer, TRUE);
            gTasks[taskId].tCounter = 0;
    ...
    case APPEALSTATE_UPDATE_CROWD:
        ...
        else
        {
            ...
            {
                if (r3 < 0)
                    StringExpandPlaceholders(gStringBuffer, gText_MonsXDidntGoOverWell);
                else if (r3 > 0 && eContest.applauseLevel <= 4)
                    StringExpandPlaceholders(gStringBuffer, gText_MonsXWentOverGreat);
                else
                    StringExpandPlaceholders(gStringBuffer, gText_MonsXGotTheCrowdGoing);
                Contest_StartTextPrinter(gStringBuffer, TRUE);
                gTasks[taskId].tCounter = 0;
    ...
    case APPEALSTATE_PRINT_CROWD_WATCHES_MSG:
        ...
        StringCopy(gStringVar1, gContestMons[contestant].nickname);
        StringCopy(gStringVar2, gMoveNames[eContestantStatus[contestant].currMove]);
        StringExpandPlaceholders(gStringBuffer, gText_CrowdContinuesToWatchMon);
        Contest_StartTextPrinter(gStringBuffer, TRUE);
    ...
    case APPEALSTATE_PRINT_MON_MOVE_IGNORED_MSG:
        ...
        {
            ContestClearGeneralTextWindow();
            StringExpandPlaceholders(gStringBuffer, gText_MonsMoveIsIgnored);
            Contest_StartTextPrinter(gStringBuffer, TRUE);
    ...
    case APPEALSTATE_PRINT_TOO_NERVOUS_MSG:
        ...
        StringCopy(gStringVar1, gContestMons[contestant].nickname);
        StringCopy(gStringVar2, gMoveNames[eContestantStatus[contestant].currMove]);
        StringExpandPlaceholders(gStringBuffer, gText_MonWasTooNervousToMove);
        Contest_StartTextPrinter(gStringBuffer, TRUE);
    ...
    case APPEALSTATE_PRINT_SKIP_TURN_MSG:
        ContestClearGeneralTextWindow();
        StringCopy(gStringVar1, gContestMons[contestant].nickname);
        StringExpandPlaceholders(gStringBuffer, gText_MonWasWatchingOthers);
        Contest_StartTextPrinter(gStringBuffer, TRUE);
...
static void Task_PrintRoundResultText(u8 taskId)
{
    if (gTasks[taskId].data[0] == 0)
    {
        ...
        StringExpandPlaceholders(gStringBuffer, sRoundResultTexts[attention]);
        Contest_StartTextPrinter(gStringBuffer, TRUE);
        gTasks[taskId].data[0]++;
    }
    else
...
static void Task_EndAppeals(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringBuffer, gText_AllOutOfAppealTime);
    Contest_StartTextPrinter(gStringBuffer, TRUE);
...
static void PrintAppealMoveResultText(u8 contestant, u8 stringId)
{
    ...
    StringExpandPlaceholders(gStringBuffer, sAppealResultTexts[stringId]);
    ContestClearGeneralTextWindow();
    Contest_StartTextPrinter(gStringBuffer, TRUE);
}
