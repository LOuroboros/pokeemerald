...
static void Task_DisplayAppealNumberText(u8 taskId)
{
    if (gTasks[taskId].data[0] == 0)
    {
        ...
        StringExpandPlaceholders(gStringVar7, gDisplayedStringBattle);
        Contest_StartTextPrinter(gStringVar7, TRUE);
        gTasks[taskId].data[0]++;
    }
    else
    {
...
static void Task_HandleMoveSelectInput(u8 taskId)
{
    ...
    else
    {
        ...
        case B_BUTTON:
            ...
            ContestClearGeneralTextWindow();
            StringExpandPlaceholders(gStringVar7, gDisplayedStringBattle);
            Contest_StartTextPrinter(gStringVar7, 0);
            gBattle_BG0_Y = 0;
            gBattle_BG2_Y = 0;
            gTasks[taskId].func = Task_TryShowMoveSelectScreen;
            break;
...
static void Task_DoAppeals(u8 taskId)
{
    ...
    case APPEALSTATE_PRINT_USED_MOVE_MSG:
        ...
        else
        {
            ...
            StringExpandPlaceholders(gStringVar7, gText_MonAppealedWithMove);
            Contest_StartTextPrinter(gStringVar7, 1);
    ...
    case APPEALSTATE_TRY_PRINT_SKIP_NEXT_TURN_MSG:
        if (gTasks[taskId].tCounter++ > 9)
        {
                ...
                || eContestantStatus[contestant].turnSkipped)
            {
                ContestClearGeneralTextWindow();
                StringCopy(gStringVar1, gContestMons[contestant].nickname);
                StringExpandPlaceholders(gStringVar7, gText_MonCantAppealNextTurn);
                Contest_StartTextPrinter(gStringVar7, 1);
            }
    ...
    case APPEALSTATE_PRINT_COMBO_MSG:
    {
        ...
        else
        {
            ...
            ContestClearGeneralTextWindow();
            StringCopy(gStringVar1, gContestMons[contestant].nickname);
            StringExpandPlaceholders(gStringVar7, gText_JudgeLookedAtMonExpectantly);
            Contest_StartTextPrinter(gStringVar7, 1);
    ...
    case APPEALSTATE_CHECK_REPEATED_MOVE:
        if (eContestantStatus[contestant].repeatedMove)
        {
            ContestClearGeneralTextWindow();
            StringCopy(gStringVar1, gContestMons[contestant].nickname);
            StringExpandPlaceholders(gStringVar7, gText_RepeatedAppeal);
            Contest_StartTextPrinter(gStringVar7, TRUE);
            gTasks[taskId].tCounter = 0;
    ...
    case APPEALSTATE_UPDATE_CROWD:
        ...
        else
        {
            ...
            {
                if (r3 < 0)
                    StringExpandPlaceholders(gStringVar7, gText_MonsXDidntGoOverWell);
                else if (r3 > 0 && eContest.applauseLevel <= 4)
                    StringExpandPlaceholders(gStringVar7, gText_MonsXWentOverGreat);
                else
                    StringExpandPlaceholders(gStringVar7, gText_MonsXGotTheCrowdGoing);
                Contest_StartTextPrinter(gStringVar7, 1);
                gTasks[taskId].tCounter = 0;
    ...
    case APPEALSTATE_PRINT_CROWD_WATCHES_MSG:
        ...
        StringCopy(gStringVar1, gContestMons[contestant].nickname);
        StringCopy(gStringVar2, gMoveNames[eContestantStatus[contestant].currMove]);
        StringExpandPlaceholders(gStringVar7, gText_CrowdContinuesToWatchMon);
        Contest_StartTextPrinter(gStringVar7, TRUE);
    ...
    case APPEALSTATE_PRINT_MON_MOVE_IGNORED_MSG:
        ...
        {
            ContestClearGeneralTextWindow();
            StringExpandPlaceholders(gStringVar7, gText_MonsMoveIsIgnored);
            Contest_StartTextPrinter(gStringVar7, TRUE);
    ...
    case APPEALSTATE_PRINT_TOO_NERVOUS_MSG:
        ...
        StringCopy(gStringVar1, gContestMons[contestant].nickname);
        StringCopy(gStringVar2, gMoveNames[eContestantStatus[contestant].currMove]);
        StringExpandPlaceholders(gStringVar7, gText_MonWasTooNervousToMove);
        Contest_StartTextPrinter(gStringVar7, TRUE);
    ...
    case APPEALSTATE_PRINT_SKIP_TURN_MSG:
        ContestClearGeneralTextWindow();
        StringCopy(gStringVar1, gContestMons[contestant].nickname);
        StringExpandPlaceholders(gStringVar7, gText_MonWasWatchingOthers);
        Contest_StartTextPrinter(gStringVar7, TRUE);
...
static void Task_PrintRoundResultText(u8 taskId)
{
    if (gTasks[taskId].data[0] == 0)
    {
        ...
        StringExpandPlaceholders(gStringVar7, sRoundResultTexts[attention]);
        Contest_StartTextPrinter(gStringVar7, TRUE);
        gTasks[taskId].data[0]++;
    }
    else
...
static void Task_EndAppeals(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringVar7, gText_AllOutOfAppealTime);
    Contest_StartTextPrinter(gStringVar7, TRUE);
...
static void PrintAppealMoveResultText(u8 contestant, u8 stringId)
{
    ...
    StringExpandPlaceholders(gStringVar7, sAppealResultTexts[stringId]);
    ContestClearGeneralTextWindow();
    Contest_StartTextPrinter(gStringVar7, 1);
}
