...
void AddTextPrinterForMessage(bool8 allowSkippingDelayWithButtonPress)
{
    ...
    AddTextPrinterParameterized2(0, FONT_NORMAL, gStringVar11, GetPlayerTextSpeedDelay(), callback, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
}

void AddTextPrinterForMessage_2(bool8 allowSkippingDelayWithButtonPress)
{
    gTextFlags.canABSpeedUpPrint = allowSkippingDelayWithButtonPress;
    AddTextPrinterParameterized2(0, FONT_NORMAL, gStringVar11, GetPlayerTextSpeedDelay(), NULL, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
}

void AddTextPrinterWithCustomSpeedForMessage(bool8 allowSkippingDelayWithButtonPress, u8 speed)
{
    gTextFlags.canABSpeedUpPrint = allowSkippingDelayWithButtonPress;
    AddTextPrinterParameterized2(0, FONT_NORMAL, gStringVar11, speed, NULL, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
}
...
void PrintMenuTable(u8 windowId, u8 itemCount, const struct MenuAction *menuActions)
{
    ...
    for (i = 0; i < itemCount; i++)
    {
        StringExpandPlaceholders(gStringVar11, menuActions[i].text);
        AddTextPrinterParameterized(windowId, 1, gStringVar11, 8, (i * 16) + 1, TEXT_SKIP_DRAW, NULL);
    }
...
void PrintPlayerNameOnWindow(u8 windowId, const u8 *src, u16 x, u16 y)
{
    ...
    AddTextPrinterParameterized(windowId, 1, gStringVar11, x, y, TEXT_SKIP_DRAW, 0);
}
