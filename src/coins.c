...
void PrintCoinsString(u32 coinAmount)
{
    ...
    StringExpandPlaceholders(gStringBuffer, gText_Coins);

    xAlign = GetStringRightAlignXOffset(FONT_NORMAL, gStringBuffer, 0x40);
    AddTextPrinterParameterized(sCoinsWindowId, FONT_NORMAL, gStringBuffer, xAlign, 1, 0, NULL);
}
