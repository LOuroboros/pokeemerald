...
static void PokeblockAction_Toss(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringVar11, gText_ThrowAwayVar1);
    DisplayMessageAndContinueTask(taskId, WIN_TOSS_MSG, 10, 13, FONT_NORMAL, GetPlayerTextSpeedDelay(), gStringVar11, CreateTossPokeblockYesNoMenu);
}
...
{
    StringExpandPlaceholders(gStringVar11, gText_Var1ThrownAway);
    DisplayMessageAndContinueTask(taskId, WIN_TOSS_MSG, 10, 13, FONT_NORMAL, GetPlayerTextSpeedDelay(), gStringVar11, TossPokeblock);
}
