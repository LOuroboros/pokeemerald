...
static void PokeblockAction_Toss(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringBuffer, gText_ThrowAwayVar1);
    DisplayMessageAndContinueTask(taskId, WIN_TOSS_MSG, 10, 13, FONT_NORMAL, GetPlayerTextSpeedDelay(), gStringBuffer, CreateTossPokeblockYesNoMenu);
}
...
{
    StringExpandPlaceholders(gStringBuffer, gText_Var1ThrownAway);
    DisplayMessageAndContinueTask(taskId, WIN_TOSS_MSG, 10, 13, FONT_NORMAL, GetPlayerTextSpeedDelay(), gStringBuffer, TossPokeblock);
}
