...
static void PokeblockAction_Toss(u8 taskId)
{
    ...
    DisplayMessageAndContinueTask(taskId, WIN_TOSS_MSG, 10, 13, 1, GetPlayerTextSpeedDelay(), gStringVar7, CreateTossPokeblockYesNoMenu);
}
...
static void TossedPokeblockMessage(u8 taskId)
{
    ...
    DisplayMessageAndContinueTask(taskId, WIN_TOSS_MSG, 10, 13, 1, GetPlayerTextSpeedDelay(), gStringVar7, TossPokeblock);
}
