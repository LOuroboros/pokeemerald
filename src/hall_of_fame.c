...
static void Task_HofPC_DrawSpritesPrintText(u8 taskId)
{
    ...
    StringExpandPlaceholders(gStringBuffer, gText_HOFNumber);

    if (gTasks[taskId].tCurrTeamNo <= 0)
        HofPCTopBar_PrintPair(gStringBuffer, gText_PickCancel, FALSE, 0, TRUE);
    else
        HofPCTopBar_PrintPair(gStringBuffer, gText_PickNextCancel, FALSE, 0, TRUE);
