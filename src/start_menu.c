...
static void ShowSafariBallsWindow(void)
{
    ...
    AddTextPrinterParameterized(sSafariBallsWindowId, 1, gStringVar7, 0, 1, 0xFF, NULL);
...
static void ShowPyramidFloorWindow(void)
{
    ...
    AddTextPrinterParameterized(sBattlePyramidFloorWindowId, 1, gStringVar7, 0, 1, 0xFF, NULL);
...
static bool32 PrintStartMenuActions(s8 *pIndex, u32 count)
{
    ...
    do
    {
        ...
        else
        {
            ...
            AddTextPrinterParameterized(GetStartMenuWindowId(), 1, gStringVar7, 8, (index << 4) + 9, 0xFF, NULL);
        }
