...
//Originally an array?
// Removing gUnknown_08C1249C, gBattleInterfaceGfx_UnusedWindow3 and gBattleInterfaceGfx_UnusedWindow4 can break battle interface elements.
...
const u32 gPartyMenuPokeballSmall_Gfx[] = INCBIN_U32("graphics/interface/party_menu_pokeball_small.4bpp.lz"); // unused, but necessary
...
const u16 gFrontierPassBg_Pal[][16] = INCBIN_U16("graphics/frontier_pass/tiles.gbapal");// size in LoadPalette calls is reported as 0xD0 << 1, which is 0x1A0, but palette is only 0x100 bytes long so normally, this loads extra garbage
const u32 gFrontierPassBg_Gfx[] = INCBIN_U32("graphics/frontier_pass/tiles.4bpp.lz");
const u32 gFrontierPassMapAndCard_Gfx[] = INCBIN_U32("graphics/frontier_pass/tiles2.8bpp.lz");
const u32 gFrontierPassBg_Tilemap[] = INCBIN_U32("graphics/frontier_pass/tiles.bin.lz");
const u16 gFrontierPassCancelButton_Tilemap[] = INCBIN_U16("graphics/frontier_pass/tilemap1.bin");
const u16 gFrontierPassCancelButtonHighlighted_Tilemap[] = INCBIN_U16("graphics/frontier_pass/tilemap2.bin");
