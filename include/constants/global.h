...
#define OPTIONS_BATTLE_TYPE_EFFECTIVENESS_HIDE 0
#define OPTIONS_BATTLE_TYPE_EFFECTIVENESS_SHOW 1

#define OPTIONS_BATTLE_ANIM_SPEED_NORMAL 0
#define OPTIONS_BATTLE_ANIM_SPEED_FAST 1
#define OPTIONS_BATTLE_ANIM_SPEED_INSTANT 2
