...
#define BAG_ITEMS_COUNT 486
#define BAG_KEYITEMS_COUNT 75
...
#define OPTIONS_BATTLE_TYPE_HIDE 0
#define OPTIONS_BATTLE_TYPE_SHOW 1

#define OPTIONS_QUICK_LOAD_ON  0
#define OPTIONS_QUICK_LOAD_OFF 1

#define OPTIONS_SPECIAL_MUSIC_ON  0
#define OPTIONS_SPECIAL_MUSIC_OFF 1
...
#define LEGACY_COSTUME     1
#define ADVENTURES_COSTUME 2
