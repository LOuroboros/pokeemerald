...
#define B_FLAG_INVERSE_BATTLE       FLAG_ENABLE_INVERSE_BATTLES    // If this flag is set, the battle's type effectiveness are inversed. For example, fire is super effective against water.
#define B_FLAG_FORCE_DOUBLE_WILD    0                              // If this flag is set, all land and surfing wild battles will be double battles.
#define B_SMART_WILD_AI_FLAG        FLAG_ENABLE_SMART_WILD_POKEMON // If not 0, you can set this flag in a script to enable smart wild pokemon
#define B_FLAG_NO_BAG_USE           FLAG_DISABLE_BATTLE_BAG_ACCESS // If this flag is set, the ability to use the bag in battle is disabled.
#define B_FLAG_NO_CATCHING          FLAG_DISABLE_BALL_THROWS       // If this flag is set, the ability to catch wild Pokémon is disabled.
