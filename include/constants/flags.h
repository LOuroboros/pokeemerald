...
#define FLAG_FORCE_SHINIES                 0x20 // Unused Flag
#define FLAG_DISABLE_TRAINER_ENCOUNTERS    0x21 // Unused Flag
#define FLAG_DISABLE_BALL_THROWS           0x22 // Unused Flag
#define FLAG_DISABLE_COLLISIONS            0x23 // Unused Flag
#define FLAG_DISABLE_BATTLE_BAG_ACCESS     0x24 // Unused Flag
#define FLAG_DISABLE_WILD_ENCOUNTERS       0x25 // Unused Flag
#define FLAG_DISABLE_ESCAPING_FROM_BATTLE  0x26 // Unused Flag
#define FLAG_DISABLE_EXPERIENCE            0x27 // Unused Flag
...
#define FLAG_SYS_ENABLE_DEBUG_MENU                   (SYSTEM_FLAGS + 0x3) // Unused Flag
