...
#define FLAG_ENABLE_NORMAN_QUEST_POKENAV_CALL               0x71 // Originally Unused Flag. Used in R/S to indicate whether player defeated or caught Groudon/Kyogre in Cave of Origin.
...
#define FLAG_SYS_QUEST_MENU_GET                     (SYSTEM_FLAGS + 0x2E) // Originally Unused Flag
