...
// Custom, combined moves
#define MOVES_COUNT_CUSTOM          MOVES_COUNT_GEN8
#define MOVE_COMBINED_WATER_PLEDGE (MOVES_COUNT_CUSTOM + 0)
#define MOVE_COMBINED_FIRE_PLEDGE  (MOVES_COUNT_CUSTOM + 1)
#define MOVE_COMBINED_GRASS_PLEDGE (MOVES_COUNT_CUSTOM + 2)

#define MOVES_COUNT         MOVES_COUNT_GEN8 + MOVES_COUNT_CUSTOM
