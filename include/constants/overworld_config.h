...
#define OW_FLAG_NO_TRAINER_SEE      FLAG_DISABLE_TRAINER_ENCOUNTERS // If this flag is set, trainers will not battle the player unless they're talked to.
...
#define DEBUG_FLAG_NO_COLLISION     FLAG_DISABLE_COLLISIONS // If this flag is set, the debug function in the Utility submenu to disable player collision can be used.
